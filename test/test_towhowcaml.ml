      ...
      (((id 0)
        ...
        (instrs
         ((0 (GetGlobalOp (var esp) (global_name __stack__) (global_type Int)))
          ...
          (17 (LoadOp (var __i32) (op Load32) (addr (Ref 12))))
          ...
          (31 (LoadOp (var __i32) (op Load32) (addr (Ref 26))))
          ...
          (39 (StoreOp (op Store32) (addr (Ref 38)) (value (Ref 23))))
          (40 (Const __i32 4))
          (41 (BiOp (var esp) (op Subtract) (lhs (Ref 35)) (rhs (Ref 40))))
          (42 (StoreOp (op Store32) (addr (Ref 41)) (value (Ref 38))))
          (43 (Const __i32 4))
          (44 (BiOp (var esp) (op Subtract) (lhs (Ref 41)) (rhs (Ref 43))))
          (45 (Const __i32 4713117))
          (46 (StoreOp (op Store32) (addr (Ref 44)) (value (Ref 45))))
          (47
          ...
          (72 (StoreOp (op Store32) (addr (Ref 71)) (value (Ref 70))))
          (73 (Const __i32 2))
       ...
       ((id 2)
        ...
        (instrs
         ((0 (OutsideContext (var eax) (typ Int))) (1 (Const __i32 8))
          ...
          (26 (LoadOp (var __i32) (op Load32) (addr (Ref 21))))
       ...
       ((id 12)
        ...
        (instrs
         ((0 (Const __i32 1)) (1 (OutsideContext (var esp) (typ Int)))
          ...
          (13 (LoadOp (var __i32) (op Load32) (addr (Ref 8))))
          ...
          (18 (LoadOp (var __i32) (op Load32) (addr (Ref 17))))
          (19 (Const __i32 4))
       ...
       ((id 14)
        ...
        (instrs
         ((0 (OutsideContext (var ecx) (typ Int)))
          ...
          (9 (LoadOp (var __i32) (op Load32) (addr (Ref 4))))
       ...
       ((id 16)
        ...
        (instrs
         ((0 (OutsideContext (var ecx) (typ Int)))
          ...
          (23 (LoadOp (var __i32) (op Load32) (addr (Ref 18))))
       ...
       ((id 18)
         ...
         ((0 (Const __i32 4)) (1 (OutsideContext (var esp) (typ Int)))
          ...
          (5
           (CallOp (var eax) (func KERNEL32.dll_GetCommandLineA) (args ())
            (return_type Int)))
          (6 (Const __i32 4713346))
          (7 (LoadOp (var __i32) (op Load32) (addr (Ref 2))))
          (8 (BiOp (var __i32) (op Equal) (lhs (Ref 7)) (rhs (Ref 6))))
          (9 (AssertOp (condition (Ref 8)))) (10 (Const __i32 4))
          (11 (BiOp (var esp) (op Add) (lhs (Ref 2)) (rhs (Ref 10))))
          (12 (Const __i32 20337236))
          (13 (StoreOp (op Store32) (addr (Ref 12)) (value (Ref 5))))
          (14 (OutsideContext (var ecx) (typ Int)))
          (15 (OutsideContext (var edx) (typ Int))) (16 (Const __i32 4))
          (17 (BiOp (var esp) (op Subtract) (lhs (Ref 11)) (rhs (Ref 16))))
          (18 (Const __i32 4713357))
          (19 (StoreOp (op Store32) (addr (Ref 17)) (value (Ref 18))))
          (20
           (CallOp (var eax) (func __func483240__) (args ((Ref 14) (Ref 15)))
            (return_type Int)))
          (21 (Const __i32 4713357))
          (22 (LoadOp (var __i32) (op Load32) (addr (Ref 17))))
          ...
          (28 (StoreOp (op Store32) (addr (Ref 27)) (value (Ref 20))))
          (29 (Const __i32 4))
          (30 (BiOp (var esp) (op Subtract) (lhs (Ref 26)) (rhs (Ref 29))))
          (31 (Const __i32 4713367))
          (32 (StoreOp (op Store32) (addr (Ref 30)) (value (Ref 31))))
          (33
           (CallOp (var eax) (func __func48319e__) (args ((Ref 14) (Ref 15)))
            (return_type Int)))
          (34 (Const __i32 4713367))
          (35 (LoadOp (var __i32) (op Load32) (addr (Ref 30))))
        ...
        (roots
         ((Ref 1) (Ref 4) (Ref 5) (Ref 9) (Ref 13) (Ref 14) (Ref 15) (Ref 19)
       ...
       ((id 24)
        ...
        (instrs
         ((0 (OutsideContext (var esi) (typ Int)))
          ...
          (7 (StoreOp (op Store32) (addr (Ref 6)) (value (Ref 3))))
          (8 (Const __i32 4))
          (9 (BiOp (var esp) (op Subtract) (lhs (Ref 6)) (rhs (Ref 8))))
          (10 (Const __i32 4713427))
          (11 (StoreOp (op Store32) (addr (Ref 9)) (value (Ref 10))))
          (12
           (CallOp (var eax) (func KERNEL32.dll_GetStartupInfoA) (args ())
            (return_type Int)))
          (13 (Const __i32 4713427))
          (14 (LoadOp (var __i32) (op Load32) (addr (Ref 9))))
          (15 (BiOp (var __i32) (op Equal) (lhs (Ref 14)) (rhs (Ref 13))))
          (16 (AssertOp (condition (Ref 15)))) (17 (Const __i32 4))
          (18 (BiOp (var esp) (op Add) (lhs (Ref 9)) (rhs (Ref 17))))
          (19 (OutsideContext (var ecx) (typ Int)))
          (20 (OutsideContext (var edx) (typ Int))) (21 (Const __i32 4))
          (22 (BiOp (var esp) (op Subtract) (lhs (Ref 18)) (rhs (Ref 21))))
          (23 (Const __i32 4713433))
          (24 (StoreOp (op Store32) (addr (Ref 22)) (value (Ref 23))))
          (25
           (CallOp (var eax) (func __func482f02__) (args ((Ref 19) (Ref 20)))
            (return_type Int)))
          (26 (Const __i32 4713433))
          (27 (LoadOp (var __i32) (op Load32) (addr (Ref 22))))
        ...
        (roots
         ((Ref 0) (Ref 1) (Ref 2) (Ref 4) (Ref 7) (Ref 11) (Ref 12) (Ref 16)
          (Ref 19) (Ref 20) (Ref 24) (Ref 25) (Ref 29) (Ref 31) (Ref 32))))
       ...
       ((id 27)
        ...
        (instrs
         ((0 (OutsideContext (var eax) (typ Int)))
          ...
          (33 (StoreOp (op Store32) (addr (Ref 32)) (value (Ref 24))))
          (34 (Const __i32 4))
          ...
          (40 (LoadOp (var __i32) (op Load32) (addr (Ref 35))))
       ...
       ((id 30) (terminator Return)
        (instrs
         ((0 (OutsideContext (var ebp) (typ Int)))
          ...
          (16 (LoadOp (var __i32) (op Load32) (addr (Ref 11))))
