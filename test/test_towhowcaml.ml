    ...
    ((id 15)
     (instrs
      ((0 (Const __i32 4)) (1 (OutsideContext (var ebp) (typ Int)))
       ...
       (7
        (CallOp (var __fl) (func __float_scale__) (args ((Ref 6) (Ref 4)))
         (return_type Float)))
       (8 (UniOp (var __fl) (op FloatAbs) (operand (Ref 7))))
       (9 (Const __i32 4820776))
       (10 (LoadOp (var __fl) (op FloatLoad64) (addr (Ref 9))))
       (11 (Landmine (var eax) (typ Int)))
       (12 (BiOp (var __i32) (op FloatGreaterThan) (lhs (Ref 8)) (rhs (Ref 10))))
       (13 (StoreOp (op FloatStore64) (addr (Ref 5)) (value (Ref 7))))))
     (terminator
      (Branch (succeed (Block 19)) (fail (Block 16)) (condition (Ref 12))))
     (roots ((Ref 1) (Ref 2) (Ref 5) (Ref 7) (Ref 11) (Ref 13)))) |}]
      ...
      ((0 (Const __i32 3)) (1 (OutsideContext (var ebp) (typ Int)))
       ...
       (7
        (CallOp (var __fl) (func __float_scale__) (args ((Ref 6) (Ref 4)))
         (return_type Float)))
       (8 (UniOp (var __fl) (op FloatAbs) (operand (Ref 7))))
       (9 (Const __i32 4820768))
       (10 (LoadOp (var __fl) (op FloatLoad64) (addr (Ref 9))))
       (11 (Landmine (var eax) (typ Int)))
       (12 (BiOp (var __i32) (op FloatGreaterThan) (lhs (Ref 8)) (rhs (Ref 10))))
       (13 (UniOp (var __i32) (op EqualsZero) (operand (Ref 12))))
       (14 (StoreOp (op FloatStore64) (addr (Ref 5)) (value (Ref 7))))))
     (terminator
      (Branch (succeed (Block 19)) (fail (Block 18)) (condition (Ref 13))))
     (roots ((Ref 1) (Ref 2) (Ref 5) (Ref 7) (Ref 11) (Ref 14)))) |}]
    ...
    ((id 1)
     (instrs
      ((0 (OutsideContext (var eax) (typ Int))) (1 (Const __i32 0))
       ...
       (18
        (SetGlobalOp (global_name __stack__) (value (Ref 16)) (global_type Int)))))
     (terminator Return)
     (roots ((Ref 0) (Ref 4) (Ref 14) (Ref 16) (Ref 17) (Ref 18)))) |}]
    ...
    ((id 7)
     (instrs
      ((0 (OutsideContext (var ebp) (typ Int)))
       ...
       (59
        (SetGlobalOp (global_name __stack__) (value (Ref 56)) (global_type Int)))
       (60
        (GetGlobalOp (var __i32) (global_name __fpuStack__) (global_type Int)))
       (61
        (StoreOp (op FloatStore64) (addr (Ref 60)) (value (Ref 49)) (offset 8)))
       (62
        (StoreOp (op FloatStore64) (addr (Ref 60)) (value (Ref 53)) (offset 16)))
       (63 (Const __i32 16))
       (64 (BiOp (var __i32) (op Add) (lhs (Ref 60)) (rhs (Ref 63))))
       (65
        (SetGlobalOp (global_name __fpuStack__) (value (Ref 64))
         (global_type Int)))
       (66
        (CallOp (var eax) (func __func48b8a0__) (args ((Ref 34) (Ref 41)))
         (return_type Int)))
       (67 (GetGlobalOp (var esp) (global_name __stack__) (global_type Int)))
       (68 (Const __i32 4212587))
       (69 (LoadOp (var __i32) (op Load32) (addr (Ref 67))))
       (70 (BiOp (var __i32) (op Equal) (lhs (Ref 69)) (rhs (Ref 68))))
       (71 (AssertOp (condition (Ref 70)))) (72 (Const __i32 4))
       (73 (BiOp (var esp) (op Add) (lhs (Ref 67)) (rhs (Ref 72))))
       (74 (StoreOp (op Store32) (addr (Ref 0)) (value (Ref 66)) (offset -8)))
     ...
     (roots
      ((Ref 0) (Ref 9) (Ref 18) (Ref 25) (Ref 32) (Ref 34) (Ref 39) (Ref 41)
       (Ref 46) (Ref 55) (Ref 58) (Ref 59) (Ref 60) (Ref 61) (Ref 62) (Ref 65)
    ...
    ((id 0)
     (instrs
      ((0 (GetGlobalOp (var esp) (global_name __stack__) (global_type Int)))
       ...
       (16 (DupVar (var ecx) (src (Ref 15)) (typ Int)))
       ...
       (22
        (SetGlobalOp (global_name __stack__) (value (Ref 19)) (global_type Int)))
       (23
        (CallOp (var eax) (func __func4011b0__) (args ((Ref 16) (Ref 17)))
         (return_type Int)))
       (24 (GetGlobalOp (var esp) (global_name __stack__) (global_type Int)))
       (25 (Const __i32 4198781))
       ...
       (57
        (SetGlobalOp (global_name __stack__) (value (Ref 55)) (global_type Int)))))
     (terminator Return)
     (roots
      ((Ref 0) (Ref 1) (Ref 4) (Ref 9) (Ref 12) (Ref 13) (Ref 14) (Ref 17)
       (Ref 21) (Ref 22) (Ref 23) (Ref 24) (Ref 28) (Ref 32) (Ref 40) (Ref 45)
       (Ref 47) (Ref 51) (Ref 55) (Ref 56) (Ref 57)))) |}]
       ...
       ((id 2)
        (instrs
         ((0 (OutsideContext (var eax) (typ Int))) (1 (Const __i32 8))
          ...
          (17 (DupVar (var edi) (src (Ref 16)) (typ Int)))
          (18 (OutsideContext (var ecx) (typ Int))) (19 (Const __i32 4))
          (20 (BiOp (var esp) (op Subtract) (lhs (Ref 13)) (rhs (Ref 19))))
          (21 (Const __i32 4713200))
        ...
        (roots
         ((Ref 0) (Ref 4) (Ref 8) (Ref 10) (Ref 11) (Ref 14) (Ref 17) (Ref 18)
