...
let count_leading_zeros = uni_op Int Instr.CountLeadingZeros Int
let long_count_leading_zeros = uni_op Long Instr.LongCountLeadingZeros Long
let bitcast_long_to_float = uni_op Long Instr.BitcastInt64ToFloat Float
let bitcast_float_to_long = uni_op Float Instr.BitcastFloatToLong Long
...
let long_rotate_right = bi_op Long Instr.LongRotateRight Long
let long_and = bi_op Long Instr.LongAnd Long
let long_or = bi_op Long Instr.LongOr Long
let long_xor = bi_op Long Instr.LongXor Long
