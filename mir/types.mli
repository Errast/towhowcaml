...
module Instr : sig
  ...
  type t =
    ...
    | VecConst of { var : variable; lower_bits : Int64.t; upper_bits : Int64.t }
    | DupVar of { var : variable; src : Ref.t; typ : local_type }
    ...
    | OutsideContext of { var : variable; typ : local_type }
